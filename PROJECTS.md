...
| `archive/workspace-agents` | `marius-patrik/workspace-agents` | Public | `main` |
| `archive/Wrkspace` | `marius-patrik/Wrkspace` | Public | `main` |
| `private/archive/Citizen` | `marius-patrik/Citizen` | Private | `main` |
| `private/archive/data-agentos` | `marius-patrik/data-agentos` | Private | `main` |
| `private/archive/workspace-darkfactory` | `marius-patrik/workspace-darkfactory` | Private | `main` |
...
2. classify them from GitHub's current `isArchived` and visibility values;
